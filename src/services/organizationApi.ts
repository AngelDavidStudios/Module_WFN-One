...
export const organizationApi = {
  ...
  ): Promise<ApiResponse<{ message: string; node: OrganizationNode }>> {
  ...
  async getSubordinates(
    nodeId: string,
  ): Promise<ApiResponse<{ subordinates: OrganizationNode[] }>> {
  ...
  async assignSupervisor(
    ...
    return ApiFacade.organization.postAction('assignSupervisor', {
      id: nodeId,
      supervisorId,
    })
  },
