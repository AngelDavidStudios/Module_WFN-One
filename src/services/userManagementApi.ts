...
export const userManagementApi = {
  ...
  > {
    return ApiFacade.userManagement.postAction('createUser', {
      email,
      username,
      temporaryPassword,
    })
  ...
  async addUserToGroup(
    ...
    return ApiFacade.userManagement.postAction('addToGroup', {
      username,
      groupName,
    })
  },
  ...
  async removeUserFromGroup(
    ...
    return ApiFacade.userManagement.postAction('removeFromGroup', {
      username,
      groupName,
    })
  },
  ...
  async getUserGroups(
    username: string,
  ): Promise<ApiResponse<{ groups: string[] }>> {
  ...
  async resetPassword(
    ...
    return ApiFacade.userManagement.postAction('resetPassword', {
      username,
      newPassword,
    })
  },
