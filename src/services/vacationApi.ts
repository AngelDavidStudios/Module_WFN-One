...
export const vacationApi = {
  ...
  async approveRequest(
    ...
    return ApiFacade.vacation.postAction('approveRequest', {
      id: requestId,
      userId,
      userEmail,
      comment,
  ...
  async rejectRequest(
    ...
    return ApiFacade.vacation.postAction('rejectRequest', {
      id: requestId,
      userId,
      userEmail,
      comment,
  ...
  async cancelRequest(
    ...
    return ApiFacade.vacation.postAction('cancelRequest', {
      id: requestId,
      userId,
    })
  },
  ...
  async getRequest(
    requestId: string,
  ): Promise<ApiResponse<{ request: VacationRequest }>> {
  ...
  async getMyRequests(
    userId: string,
  ): Promise<ApiResponse<{ requests: VacationRequest[] }>> {
  ...
  async getPendingApprovals(
    ...
    return ApiFacade.vacation.postAction('getPendingApprovals', {
      userId: supervisorId,
    })
  },
  ...
  async getAllRequests(): Promise<
    ApiResponse<{ requests: VacationRequest[] }>
  > {
  ...
  async getBalance(
    userId: string,
  ): Promise<ApiResponse<{ balance: VacationBalance }>> {
  ...
  async getAllBalances(): Promise<
    ApiResponse<{ balances: VacationBalance[] }>
  > {
